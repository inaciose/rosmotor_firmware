 ...
 * 
 * version with custom message diff_drive_base1/WheelControl
 * 
 */
...
void wheelControlCallback(const diff_drive_base1::WheelControl& wheel_control_msg) {
  leftMotorPwmOut = (int)(wheel_control_msg.left_wheel_speed * 255);
  rightMotorPwmOut = (int)(wheel_control_msg.right_wheel_speed * 255);
}

ros::Subscriber<diff_drive_base1::WheelControl> wheelControlSubscriber("wheel_control", &wheelControlCallback);
